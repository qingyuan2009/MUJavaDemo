...
public interface DistributionCenters_ extends StructuredType<DistributionCenters_> {
  String CDS_NAME = "MUService.DistributionCenters";
  ...
  DistributionCenters_ SiblingEntity();

  DistributionCenters_ SiblingEntity(Function<DistributionCenters_, CqnPredicate> filter);
}
